    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50">
      <div className="w-full max-w-sm bg-white rounded-xl shadow-lg p-8">
        <div className="mb-6">
          ...
          <p className="text-sm text-zinc-500 mt-1">Brand Portal</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input type="text" value={totpCode} onChange={e => setTotpCode(e.target.value)} required
              ...
              className="w-full px-3 py-2 border border-zinc-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 font-mono tracking-widest text-center text-lg" />
          </div>
        ...
        <p className="text-xs text-zinc-400 mt-4 text-center">8-hour session &middot; Multi-tenant isolation</p>
      </div>
    </div>
  );
}
